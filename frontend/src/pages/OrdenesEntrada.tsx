                      ...
                      >
                        ...
                        {o.items.length === 0 ? (
                          <p className="text-h-tertiary text-sm italic">
                            Sin items. Agrega items antes de confirmar la orden.
                          </p>
                        ) : (
                        ...
                        {o.notas && (
                          <p className="text-xs text-h-tertiary mt-3 italic">
                            Notas: {o.notas}
                          </p>
                        )}
                      </td>
        ...
        >
          <div className="space-y-4">
            ...
            <div>
              ...
              <HSelect
                value={formOrden.actividad_duoc}
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-2 cursor-pointer select-none">
              ...
              <span className="text-sm text-h-secondary font-semibold">
                Es un item nuevo (no existe en Hestia)
              </span>
            </label>
