...
export function Paquetes() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      {/* Tabla — overflow-x-auto para evitar cortes */}
          ...
          <table className="w-full min-w-[800px] text-sm">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50">
                ...
                {/* carrera: ancho fijo para que el badge no se corte */}
                <th className="text-left px-4 py-3 text-xs font-bold text-slate-500
                  ...
                  <>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 max-w-[220px]">
                        {asig ? (
                          <span className="flex items-start gap-1.5 text-slate-600 text-sm">
